...
VALUES ('Prime Ribeye Steak', 'Dry-aged ribeye with rich marbling, grilled over high heat and served with herb butter.', 54.00, 'Prime Cuts', true, true, false, false, false, false);

INSERT INTO menu (menu_name, description, price, category, chef_choice, gluten_free, lactose_free, contains_nuts, vegan, vegetarian)
VALUES ('Tomahawk Steak for Two', 'Large bone-in rib steak, carved tableside and served with roasted garlic jus.', 118.00, 'Prime Cuts', true, true, true, false, false, false);

INSERT INTO menu (menu_name, description, price, category, chef_choice, gluten_free, lactose_free, contains_nuts, vegan, vegetarian)
VALUES ('Filet Mignon', 'Tender center-cut beef filet with red wine reduction and seasonal vegetables.', 62.00, 'Prime Cuts', true, true, true, false, false, false);

INSERT INTO menu (menu_name, description, price, category, chef_choice, gluten_free, lactose_free, contains_nuts, vegan, vegetarian)
VALUES ('Beef Short Ribs', 'Slow-braised beef short ribs with smoked demi-glace and creamy mashed potatoes.', 39.50, 'Beef Classics', false, false, false, false, false, false);

INSERT INTO menu (menu_name, description, price, category, chef_choice, gluten_free, lactose_free, contains_nuts, vegan, vegetarian)
VALUES ('Steak Tartare', 'Hand-cut beef tenderloin with capers, shallots, mustard, egg yolk and toasted bread.', 29.00, 'Starters', false, false, true, false, false, false);
